...
Shipi18n is a translation quality tool, so a lot of our discussion is about whether a translation is
*wrong*. Be careful to critique the string, not the speaker. Many contributors will be reporting
issues about their own native language in their second one — assume competence, ask what the
translation should have said, and take native-speaker judgement seriously even when a model
disagrees.
...
[GitHub's private reporting](https://github.com/Shipi18n/shipi18n/security/advisories/new), or by
[reporting the content to GitHub](https://github.com/contact/report-abuse) if it is urgent or
involves a maintainer.
